describe('template spec', () => {
  it('pagevalidation', () => {
    ...
    cy.visit("https://www.dev.trydiscs.com/advanced-search")

    cy.wait(3000)
    
    cy.get('.text-h4').should('contain','ADVANCED DISC SEARCH') // title validation

    //cy.get('thead > .q-tr > :nth-child(1)').should('contain','BRAND') //table col name validation

    cy.get('tbody > :nth-child(1) > :nth-child(1) > .disc-image').should('be.visible') // disc image validation
    ...
    cy.url().should('eq','https://www.dev.trydiscs.com/') // home page url validation
