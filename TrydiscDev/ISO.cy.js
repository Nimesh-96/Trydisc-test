describe('template spec', () => {
  ...
  it('homepage', () => {
    ...
    cy.visit('https://dev.trydiscs.com/')
  ...
  it('validation', () => {
    cy.visit('https://dev.trydiscs.com/iso-search?q=ace&country=us')//visit site
  ...
  it('discsearch', () => {
    ...
    cy.get('.q-field__control-container > .q-placeholder').clear().type('ace or hex')
    ...
    cy.get('.q-field__control-container > .q-placeholder').clear().type('ace and hex') //type names
