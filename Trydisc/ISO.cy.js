describe('template spec', () => {
  it('validation', () => {
    ...
    cy.visit('https://trydiscs.com/iso-search?q=ace&country=us')//visit site
  ...
  it('discsearch', () => {
    ...
    cy.visit('https://trydiscs.com/iso-search?q=ace&country=us')
    ...
    cy.get('.q-manual-focusable--focused').click() // change into all country
